...
\InvestigationSkillModifier{+2} % +5 Observant
\MedicineSkillModifier{+4}
\NatureSkillModifier{+2}
\PerceptionSkillModifier{+4} % +5 Observant
...
\IntelligenceProficiency{True}% druid
\WisdomProficiency{True}%druid
\CharismaProficiency{}

\AcrobaticsProficiency{}
\AnimalHandlingProficiency{}
\ArcanaProficiency{True} % druid
\AthleticsProficiency{}
\DeceptionProficiency{}
\HistoryProficiency{} 
\InsightProficiency{True} % druid
\IntimidationProficiency{}
\InvestigationProficiency{}
\MedicineProficiency{True} % druid
\NatureProficiency{}
\PerceptionProficiency{True} % druid
\PerformanceProficiency{}
\PersuasionProficiency{}
\ReligionProficiency{True} % acolythe
...
\textbf{Languages:}\\Common, Draconic, drwarish, gnomish, druidic, elivish\\
\textbf{Armor:}\\None\\
